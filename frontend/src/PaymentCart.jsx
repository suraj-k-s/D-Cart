...
export default class PaymentClassNew extends Component {
  state = {
  ...
  submitData()
  {
    ...
    formData.append("id", window.sessionStorage.getItem("bookingid"));
        axios({
            method: "POST",
            url: "http://localhost/d-cart/backend/User/Checkout.php",
            data: formData,
